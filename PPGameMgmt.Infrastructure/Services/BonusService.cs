...
namespace PPGameMgmt.Infrastructure.Services
{
    ...
    public class BonusService : IBonusService
    {
        ...
        private readonly PPGameMgmt.Core.Interfaces.Repositories.IBonusClaimRepository _bonusClaimRepository;
        private readonly ILogger<BonusService> _logger;

        public BonusService(
            IBonusRepository bonusRepository,
            PPGameMgmt.Core.Interfaces.Repositories.IBonusClaimRepository bonusClaimRepository,
        ...
        public async Task<BonusEntities.Bonus> GetBonusAsync(string bonusId)
        {
            ...
            var result = await _bonusRepository.GetByIdAsync(Guid.Parse(bonusId)); // Convert string to Guid
        ...
        public async Task<IEnumerable<BonusEntities.Bonus>> GetAllActiveBonusesAsync()
        {
            ...
            var bonuses = await _bonusRepository.ListAllAsync();
            return bonuses
        ...
        public async Task<IEnumerable<BonusEntities.BonusClaim>> GetPlayerBonusClaimsAsync(string playerId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new List<BonusEntities.BonusClaim>();
            }
        }
