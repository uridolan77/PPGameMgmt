...
import { Badge, BadgeProps } from '../..'; // Import from centralized UI library
import { cn } from '@/lib/utils';
import { BaseProps } from '../types';

export type StatusType = 'success' | 'warning' | 'error' | 'info' | 'default' | 'pending';

export interface StatusBadgeProps extends Omit<BadgeProps, 'variant'>, BaseProps {
  /**
  ...
  /**
   * Whether to show a colored dot before the label
   */
  dot?: boolean;
 ...
 * <StatusBadge status="error" label="Failed" dot={false} />
 * <StatusBadge status="pending" label="Processing" variant="outline" />
 * ```
 */
