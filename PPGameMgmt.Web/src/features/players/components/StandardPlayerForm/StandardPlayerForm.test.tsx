...
import { StandardPlayerForm } from './StandardPlayerForm';
...
describe('StandardPlayerForm', () => {
  ...
  test('renders all form fields correctly', () => {
    render(<StandardPlayerForm onSubmit={mockSubmit} />);
  ...
  test('shows registration date field when in edit mode', () => {
    render(<StandardPlayerForm onSubmit={mockSubmit} isEditing={true} />);
  ...
  test('does not show registration date field when in create mode', () => {
    render(<StandardPlayerForm onSubmit={mockSubmit} isEditing={false} />);
  ...
  test('shows correct submit button text based on isEditing prop', () => {
    const { rerender } = render(<StandardPlayerForm onSubmit={mockSubmit} isEditing={false} />);
    
    expect(screen.getByText('Create Player')).toBeInTheDocument();
    
    rerender(<StandardPlayerForm onSubmit={mockSubmit} isEditing={true} />);
  ...
  test('calls onCancel when cancel button is clicked', () => {
    render(<StandardPlayerForm onSubmit={mockSubmit} onCancel={mockCancel} />);
